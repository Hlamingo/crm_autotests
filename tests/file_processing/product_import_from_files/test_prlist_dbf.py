...
class TestPrlistDBF(ProductsBaseTest):
    ...
    def get_crm_data_by_product_code(self, code, prlist_dbf_data, product_properties_from_crm):
    ...
    def test_check_site_price(self, code):
        if 200502 not in self.prlist_dbf:
            pytest.skip(f"Для товара {code} отсутствует запись с PAYFORM_ID = 200502 в файле")
    ...
    def test_check_moc_price(self, code):
        if 200127 not in self.prlist_dbf:
            pytest.skip(f"Для товара {code} отсутствует запись с PAYFORM_ID = 200127 в файле")
    ...
    def test_cgeck_mrc_price(self, code):
        if 200125 not in self.prlist_dbf:
            pytest.skip(f"Для товара {code} отсутствует запись с PAYFORM_ID = 200125 в файле")
    ...
    def test_check_rrc_price(self, code):
        if 200500 not in self.prlist_dbf:
            pytest.skip(f"Для товара {code} отсутствует запись с PAYFORM_ID = 200500 в файле")
    ...
    def test_check_base_price(self, code):
        if 200114 not in self.prlist_dbf:
            pytest.skip(f"Для товара {code} отсутствует запись с PAYFORM_ID = 200114 в файле")
